...
rackName A1-115 120 125 128 142 147 145
...
declare @i__logComCode varchar(100) = 'ㅌ089'--(SELECT top 1 comCode FROM dbo.UF_GetGroupComCode((select comCode from UF_ErpOperate(''))))
        , @i__consignCustCode varchar(100) = 'ㅌ089'
