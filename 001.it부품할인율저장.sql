...
select * from dbo.it_0829 where ISNULL(purRate,0) =0


select * from dbo.e_othersalerate
select * from dbo.e_othersalerate where custCode = 'ㅇ479'

SELECT b.itemNo,b.makerCode
FROM dbo.it_0829 b
...
,uptUserId
,modified)
SELECT 'ㄱ121' , 'ㅇ499', b.itemId,a.purRate ,'jyspan',GETDATE(),'jyspan',GETDATE()
from dbo.vag_0714 a
